...
_url_ffmpeg="gitweb-dlagent://github.com/nyanmisaka/ffmpeg-rockchip.git#branch=${_ff_branch}"
...
pkgver() {
  ...
  printf "r%s.%s.patch.%u.%u" $_revnum $_commit ${_patchlevel} ${_timestamp_all}
}
